  ...
  return (
    <main className="w-full">
      <article aria-labelledby="recipe-title">
        {/* HERO */}
        <header className="mx-auto max-w-7xl px-4 pt-12 md:px-8 md:pt-14">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:items-center">
            <div>
              <h1
                id="recipe-title"
                className="text-4xl font-semibold text-(--text-title) md:text-5xl"
              >
                {recipe.title}
              </h1>
            ...
            <div className="md:justify-self-end">
              <div className="overflow-hidden rounded-3xl">
                <img
                  src={cld(recipe.image || "", { w: 1040, mode: "limit" })}
            ...
            <div>
              ...
              <div className="mt-8 flex justify-center md:block">
                <button
                  ...
                  className="mt-8 inline-flex cursor-pointer items-center justify-center rounded-xl border-2 border-(--accent-olive) px-7 py-3 text-sm font-semibold text-(--accent-olive) transition hover:border-(--accent-wine) hover:text-(--accent-wine) disabled:cursor-not-allowed disabled:opacity-50"
            ...
            <div className="lg:pl-10">
              <div className="flex flex-col items-center gap-5 text-center md:flex-row md:items-start md:text-left">
                <div className="h-20 w-20 shrink-0 overflow-hidden rounded-full bg-(--border-soft)">
                  {chefImage ? (
                    <img
                      src={cld(chefImage, { w: 160, h: 160, mode: "fill" })}
                      alt={`Photo of ${chefName || "Chef"}`}
        ...
        <section className="mx-auto max-w-7xl px-0 pb-10 md:px-0">
          ...
          <ol className="mt-10 space-y-14">
            {recipe.instructions.map((step, idx) => {
              ...
              return (
                <li key={idx} className="mx-auto max-w-7xl">
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:items-center">
                    ...
                    <div className={`${isEven ? "md:order-2" : "md:order-1"}`}>
                      ...
                      >
                        {step.image ? (
                          <img
                            src={cld(step.image, { w: 900, mode: "limit" })}
                            alt={`Photo of ${step.title} step`}
